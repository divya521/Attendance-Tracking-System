...
export function NewsletterForm({ className, onSubmit, submitBtn, email, setEmail}) {
  ...
  return (
    ...
    >
      {!submitBtn && <div className="mr-2 flex-shrink flex-grow">
      ...
      {submitBtn && <div className="control">
        <button
